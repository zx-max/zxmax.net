...
public class AppModule
{
        ...
        MappedConfiguration<String, Object> configuration)
    {
        ...
        configuration.override(SymbolConstants.ENABLE_HTML5_SUPPORT, true);
        configuration.override(SymbolConstants.INCLUDE_CORE_STACK, true);
    ...
    {
//    	InjectDefaultStyleheet:   Override for object 'InjectDefaultStyleheet' is invalid as it does not match an existing object.
//    	InjectDefaultStylesheet:  Override for object 'InjectDefaultStylesheet' is invalid as it does not match an existing object.
